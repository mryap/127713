...
hist(xtabs(~id, data=impress), xlab="Impressions", ylab="Number of Users",
     main="Impressions per User")
```
...
```{r}
# Create an ad stock variable to account for the decay of advertising
...
### ad stocks agains the transactions
```{r}
